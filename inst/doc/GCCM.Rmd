...
``` r
simplex(popd_sf, "pre", "pre", E = 1:10, k = 6)
## The suggested E and k for variable pre is 3 and 6
simplex(popd_sf, "popd", "popd", E = 1:10, k = 6)
...
## Time difference of 2.906415 mins
pd_res
...
``` r
simplex(npp, "pre", "pre", E = 1:10, k = 8, lib = nnaindice, pred = predindice)
## The suggested E and k for variable pre is 2 and 8
simplex(npp, "npp", "npp", E = 1:10, k = 8, lib = nnaindice, pred = predindice)
...
endTime = Sys.time()
print(difftime(endTime,startTime, units ="mins"))
## Time difference of 1.497058 mins
npp_res
##   libsizes  pre->npp  npp->pre
## 1       10 0.1282926 0.1095679
## 2       30 0.2600400 0.2314889
## 3       50 0.3773544 0.2953962
## 4       70 0.4968743 0.3400436
## 5       90 0.5976269 0.3387017
## 6      110 0.7363194 0.3422293
## 7      130 0.8387112 0.3656638
```
